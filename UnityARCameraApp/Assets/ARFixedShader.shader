...
uniform mat4 _UnityDisplayTransform;
            ...
            void main()
            {
                ...
                textureCoord = (_UnityDisplayTransform * vec4(1.0f,1080.0f/1560.0f,1.0f,1.0f)
                                * vec4(1.0f-gl_MultiTexCoord0.x, gl_MultiTexCoord0.y+(240.0f/1560.0f), 1.0f, 0.0f)).xy;
#endif // SHADER_API_GLES3
            }
#endif // VERTEX
